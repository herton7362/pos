...
@Component("memberProfitService")
@Transactional
public class MemberProfitServiceImpl extends AbstractCrudService<Member> implements MemberProfitService {
...
//                }
    ...
    @Lazy
    @Autowired
    public MemberProfitServiceImpl(
